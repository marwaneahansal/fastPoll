...
var staticRenderFns = [
  function() {
    ...
    return _c(
      "div",
      { staticClass: "py-4 flex items-center justify-between" },
      [
        _c("h3", { staticClass: "text-3xl" }, [
          _vm._v("Fast"),
          _c("span", { staticClass: "text-blue-500" }, [_vm._v("Poll")])
        ]),
        _vm._v(" "),
        _c("div", [
          _c("a", { staticClass: "text-xl mr-4", attrs: { href: "#" } }, [
            _vm._v("Public Polls")
          ]),
          _vm._v(" "),
          _c(
            "a",
            { staticClass: "text-blue-500 text-xl", attrs: { href: "#" } },
            [_vm._v("Create poll")]
          )
        ])
      ]
