	...
	<div id="userPolls">
            ...
            <vs-select placeholder="Order by" v-model="orderByOption" color="success">
              ...
              >
                ...
                No Polls found!
                <a @click="$router.push({name: 'create_poll'})" class="text-blue-500 cursor-pointer">Create your first poll now</a>
              </p>
					</div>
			</div>
	</div>
...
export default {
  ...
  methods: {
    getPolls() {
      ...
      this.$store.dispatch('polls/getUserPolls',
        {
...
<style>
    ...
    #userPolls .cards, #userPolls .searchInput {
        width: 60% !important;
    }
    ...
    html.dark #userPolls .vs-input-content {
      background-color: unset !important;
		...
		html.dark #userPolls .vs-select__input {
			background-color: rgba(17, 24, 39, var(--tw-bg-opacity)) !important;
			color: white;
		}
